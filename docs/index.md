...
| 部分 | 简介 | 组别 | 状态 |
| ---- | ---- | ---- | ---- |
| 第零部分 | 前置知识与环境准备。 | [`0A Python 基础`](./00_Prerequisites/0A.md) / [`0B PyTorch 基础`](./00_Prerequisites/0B.md) / [`0C 深度学习基础`](./00_Prerequisites/0C.md) / [`0D 工具与调试`](./00_Prerequisites/0D.md) | 🚧 部分完成 |
...
| 第二部分 | PyTorch 算法实战。 | [`2.1 基础算子`](./02_PyTorch_Algorithms/2_1.md) / [`2.2 模型架构`](./02_PyTorch_Algorithms/2_2.md) / [`2.3 微调与训练技术`](./02_PyTorch_Algorithms/2_3.md) / [`2.4 对齐技术`](./02_PyTorch_Algorithms/2_4.md) / [`2.5 反向传播与显存优化`](./02_PyTorch_Algorithms/2_5.md) / [`2.6 核心推理优化`](./02_PyTorch_Algorithms/2_6.md) / [`2.7 高级推理优化`](./02_PyTorch_Algorithms/2_7.md) / [`2.8 分布式与扩展`](./02_PyTorch_Algorithms/2_8.md) | ✅ 完成 |
| 第三部分 | CUDA C++ 与 Triton 算子开发。 | [`3.1 Triton 基础`](./03_CUDA_and_Triton_Kernels/3_1.md) / [`3.2 Triton 进阶`](./03_CUDA_and_Triton_Kernels/3_2.md) / [`3.3 Triton 项目`](./03_CUDA_and_Triton_Kernels/3_3.md) / [`3.4 CUDA 内核与显存优化`](./03_CUDA_and_Triton_Kernels/3_4.md) / [`3.5 CUDA 系统扩展`](./03_CUDA_and_Triton_Kernels/3_5.md) | ✅ 完成 |

## 🚀 快速开始

如果你想开始学习，直接从在线站点或左侧章节目录进入即可。环境选择和平台差异统一看 [使用指南](./guide.md)。
...
| Part 2 | [`2.1 基础算子`](./02_PyTorch_Algorithms/2_1.md) / [`2.2 模型架构`](./02_PyTorch_Algorithms/2_2.md) / [`2.3 微调与训练技术`](./02_PyTorch_Algorithms/2_3.md) / [`2.4 对齐技术`](./02_PyTorch_Algorithms/2_4.md) / [`2.5 反向传播与显存优化`](./02_PyTorch_Algorithms/2_5.md) / [`2.6 核心推理优化`](./02_PyTorch_Algorithms/2_6.md) / [`2.7 高级推理优化`](./02_PyTorch_Algorithms/2_7.md) / [`2.8 分布式与扩展`](./02_PyTorch_Algorithms/2_8.md) | PyTorch algorithm practice. | ✅ Complete | [Guide](./02_PyTorch_Algorithms/intro.md) |
| Part 3 | [`3.1 Triton 基础`](./03_CUDA_and_Triton_Kernels/3_1.md) / [`3.2 Triton 进阶`](./03_CUDA_and_Triton_Kernels/3_2.md) / [`3.3 Triton 项目`](./03_CUDA_and_Triton_Kernels/3_3.md) / [`3.4 CUDA 内核与显存优化`](./03_CUDA_and_Triton_Kernels/3_4.md) / [`3.5 CUDA 系统扩展`](./03_CUDA_and_Triton_Kernels/3_5.md) | CUDA C++ and Triton kernel development. | ✅ Complete | [Guide](./03_CUDA_and_Triton_Kernels/intro.md) |
