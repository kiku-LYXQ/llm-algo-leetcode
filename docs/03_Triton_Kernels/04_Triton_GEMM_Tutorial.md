...
>
> [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/datawhalechina/llm-algo-leetcode/blob/main/03_Triton_Kernels/04_Triton_GEMM_Tutorial.ipynb)
...
**导语：** 这一节先看 Part 1 的访存、执行模型和 Triton Block 相关 Group，把矩阵分块和块级调度的直觉先立起来。
...
**导语：** 如果想补一层更底层的性能背景，可以继续看 TensorCore 的深挖页；不影响继续读本节，但会更容易理解算力上限。
