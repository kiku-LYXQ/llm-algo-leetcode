...
| Task 5 | [06.5 Triton 设计模式与过渡总结](../docs/03_CUDA_and_Triton_Kernels/06_5_Triton_Design_Patterns.md) | 把 Triton 的常用模式收束成可复用骨架。 |
...
- [06.5 Triton 设计模式与过渡总结](../docs/03_CUDA_and_Triton_Kernels/06_5_Triton_Design_Patterns.md)
